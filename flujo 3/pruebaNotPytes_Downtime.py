...
if __name__== '__main__':
    driver=webdriver.Chrome('C:/Users/09384038/Documents/GitHub/PepsiCoTestAutomation/flujo 3/chromedriver.exe')
...
# slector del downtime = document.querySelector("#root_pagemashupcontainer-6_ContainedMashup-13_ptcstabset-237").shadowRoot.querySelector("ptcs-tabs > ptcs-tab:nth-child(5) > ptcs-label").shadowRoot.querySelector("#label")