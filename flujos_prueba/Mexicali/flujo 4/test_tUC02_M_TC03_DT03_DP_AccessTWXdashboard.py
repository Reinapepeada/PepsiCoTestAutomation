...
class TestTUC01_M_TC02_DT03_DP_AccessTWXdashboard():
  ...
  def test_tUC01_M_TC02_DT03_DP_AccessTWXdashboard(self):
    ...
    # circulo=self.driver.find_element(By.XPATH,'//*[@id="root_pagemashupcontainer-6_ContainedMashup-13_ContainedMashup-89_timeserieschart-27"]/svg/circle[24]')
    # circulo.click()
    time.sleep(10)
    info=self.driver.find_element(By.XPATH,'//body[1]/div[13]/div[2]').text
    print(info)
