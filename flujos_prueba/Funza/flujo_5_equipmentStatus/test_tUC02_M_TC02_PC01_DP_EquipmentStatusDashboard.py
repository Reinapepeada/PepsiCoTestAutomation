...
class TestTC02MPC04DPEntitySelectionleftslider:
    ...
    def test_tC02MPC04DPEntitySelectionleftslider(self):
        ...
        self.driver.find_element(
            By.XPATH,
            "/html/body/div[1]/div[3]/div/div[2]/div/div/div[2]/div/div[1]/div/div[2]/div/div/div/div/div/ul/li[4]/table/tbody/tr/td/div/a/span",
        ).click()
        time.sleep(4)
        # ----------------------
        ...
        tiposEquipo = [
            ["Equipo", "Conectados", "Desconectados"],
            ["Weigher", 0, 0],
            ["BagMaker", 0, 0],
            ["Inspector", 0, 0],
            ["CheckWeigher", 0, 0],
        ...
        for f in range(2, filas + 1):
            ...
            linea = self.driver.find_element(
                By.XPATH, TABLEPATH + "/tr[" + str(f) + "]/td[2]"
            ).text
            tubo = self.driver.find_element(
                By.XPATH, TABLEPATH + "/tr[" + str(f) + "]/td[3]"
            ).text
            # recorro las columnas de la fila
            print(
                "departamento: " + departamento + " linea: " + linea + " tubo: " + tubo
            )
            for c in range(19, columnas + 1):
                ...
                nombreEquipo = self.driver.find_element(
                    By.XPATH, TABLEPATH + "/tr[" + str(f) + "]/td[" + str(c) + "]"
                ).text
                ...
                if "twdhtmlxcell cell_style1" in equipoClase and len(nombreEquipo) > 6:
                    equipoNoFuncionando = True
                    errores.append([linea, tubo, nombreEquipo])
                # si el nombre del equipo es mayor a 6 es porque es un equipo
                print(nombreEquipo)
        ...
        pathExcel2 = (
            pathOG + "/reportOutput/equiposDesconectados" + str(variable) + ".xlsx"
        )
        pathExcel3 = (
            pathOG + "/reportOutput/ReporteTiposEquipos" + str(variable) + ".xlsx"
        )
        ...
        convertTo.creartablaExcel(
            tiposEquipo, pathExcel3, "reporteTiposEquipos_" + PLANTA
        )
